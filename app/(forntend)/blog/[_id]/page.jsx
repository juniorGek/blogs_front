...
const Page = () => {
  ...
  return (
    <div className="dark:bg-BG_Color">
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3 container  gap-10">
        <div className="col-span-2 pt-16 md:pt-32" >
          <div className="">
        ...
        <div className="col-span-2 lg:col-span-1">
          <h1 className='text-center md:header_1 header_3 text-Font1_Color dark:text-white mb-10 py-8'>{i18n?.t('Related Article')}</h1>
          <div className="flex flex-col  gap-10 ">
            {
              blog?.relatedBlogs && blog?.relatedBlogs.length > 0 ? blog?.relatedBlogs.slice(0, 3).map((item) => (
                <div key={item?._id}>
                  <ArticalCard item={item} />
                </div>
              )) : <div className='flex items-center py-8'>
                <h1 className='text-Primary_Color dark:text-white '>{i18n?.t('No Related Article')}</h1>
              </div>
            }
      ...
      <div className="container">
        <h1 className='text-center md:header_1 header_3 text-Font1_Color dark:text-white mb-10 py-8'>{i18n?.t('More Articles')}</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4" >
          {
            blog?.relatedBlogs && blog?.relatedBlogs.length > 0 ? blog?.relatedBlogs.slice(-3).map((item) => (
              <div key={item?._id}>
                <ArticalCard item={item} />
              </div>
            )) : <div className='flex items-center py-8'>
